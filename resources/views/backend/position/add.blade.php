              ...
              <form class="form-horaizontal" action="{{ url('admin/payroll/store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-gorup row mt-2">
                    ...
                    <div class="col-sm-10">
                      <input class="form-control" type="text" name="position_name" value="{{ old('position_name') }}" placeholder="Enter Position Name">
                    </div>
                  </div>            
                  <div class="form-gorup row mt-2">
                  ...
                  <div class="form-gorup row mt-2">
                    ...
                    <div class="col-sm-10">
                      <input class="form-control" type="number" name="working_days_per_month" value="{{ old('working_days_per_month') }}" placeholder="Enter Working Days Per Month">
                    </div>
                  </div>            
